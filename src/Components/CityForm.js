    ...
    return (
        <div className="mainform">
                    ...
                    formData.regions.map((elt, idx) => {
                        ...
                        return (
                            <Card className={classes.cardRoot}>
                                <CardHeader
                                    avatar={
                                        <Button variant="contained" color="secondary" onClick={() => {delRegion(idx)}}>
            ...
            <div className={classes.btnRoot}>
                <Button variant="contained" onClick={() => {incRegion()}}>Add New Region</Button>
                <Button variant="contained" color="primary" onClick={() => {saveData()}}>Save and Continue</Button>
                <Button variant="contained" color="secondary" onClick={() => {clearData()}}>Clear Data</Button>
            </div>
        </div>
    )
}
